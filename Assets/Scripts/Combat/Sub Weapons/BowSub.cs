...
[CreateAssetMenu(menuName = "Subweapons/Bow")]
public class BowSub : SubweaponBase
{
    ...
    {
        defaultJS = controller.jumpState;

        PlayerStats.instance.OnDamage += TookDamage;

        controller.SetupSubweaponProjectile(projectilePrefab);
        ...
        //controller.jumpState = defaultJS;
