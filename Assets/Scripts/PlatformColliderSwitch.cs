...
public class PlatformColliderSwitch : MonoBehaviour
{
	...
	private CharacterController Body => GameManager.instance.controller.Body;
	private Transform Reference => GameManager.instance.controller.transform;
	...
	void Update()
	{
		...
		float topPosition = colliderObject.transform.position.y +
			((colliderObject.size.y / 2) * colliderObject.transform.lossyScale.y) +
